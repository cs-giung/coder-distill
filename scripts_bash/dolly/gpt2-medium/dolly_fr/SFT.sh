...
# Models
MODEL="checkpoints/dolly/gpt2-medium/init"

# Datasets
INITIAL_DATA_JSONL="data/dolly/dolly_fr.jsonl"
LIMIT=13312

# Parameters
EPOCHS=10
OUTPUT_ROOT="checkpoints/dolly/gpt2-medium/dolly_fr/SFT"
...
do    
    ...
    .venv/bin/python scripts/eval_dolly.py \
        --model $CURRENT_MODEL \
        --data_path data/dolly_eval/dolly_fr.jsonl \
        --output_file $CURRENT_MODEL/dolly_eval/dolly_fr.jsonl
