...
# Datasets
INITIAL_DATA_JSONL="data/dolly/dolly_de.jsonl"
LIMIT=13312

# Parameters
EPOCHS=10
OUTPUT_ROOT="checkpoints/dolly/gpt2-medium/dolly_de/SFT"
...
do    
    ...
    .venv/bin/python scripts/eval_dolly.py \
        --model $CURRENT_MODEL \
        --data_path data/dolly_eval/dolly_de.jsonl \
        --output_file $CURRENT_MODEL/dolly_eval/dolly_de.jsonl
