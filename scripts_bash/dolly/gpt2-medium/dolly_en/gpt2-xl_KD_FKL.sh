...
# Models
TEACHER_MODEL="checkpoints/dolly/gpt2-xl/dolly_en/SFT/epoch_6/final_model"
STUDENT_MODEL="checkpoints/dolly/gpt2-medium/dolly_en/SFT/epoch_8/final_model"
...
# Parameters
EPOCHS=10
OUTPUT_ROOT="checkpoints/dolly/gpt2-medium/dolly_en/gpt2-xl_KD_FKL"
